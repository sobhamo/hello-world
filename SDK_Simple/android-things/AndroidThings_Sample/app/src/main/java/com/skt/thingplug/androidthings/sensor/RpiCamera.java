...
public class RpiCamera {
    ...
    public interface TakePictureListener{
        void onPictureTaken(final byte[] imageBytes);
    }
    ...
    private static class InstanceHolder {
        private static RpiCamera mCamera = new RpiCamera();
    }
            ...
            new ImageReader.OnImageAvailableListener() {
                ...
                public void onImageAvailable(ImageReader reader) {
                    if(null != takePictureListener) {
                        ...
                        image.close();
                        takePictureListener.onPictureTaken(imageBytes);
                    }
                }
            };

    private void updateImageAvailableListener(ImageReader.OnImageAvailableListener imageAvailableListener, Handler backgroundHandler){
        mImageReader.setOnImageAvailableListener(
                imageAvailableListener, backgroundHandler);
    }
