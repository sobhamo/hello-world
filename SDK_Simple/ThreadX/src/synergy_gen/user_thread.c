...
#if !defined(SSP_SUPPRESS_ISR_g_i2c) && !defined(SSP_SUPPRESS_ISR_SCI0)
...
#endif
sci_i2c_instance_ctrl_t g_i2c_ctrl;

/** I2C extended configuration */
const sci_i2c_extended_cfg g_i2c_cfg_extend =
...
#undef SYNERGY_NOT_DEFINED
  .p_callback = NULL,
  .p_context = (void *) &g_i2c, .rxi_ipl = (10), .txi_ipl = (10), .tei_ipl = (10), .eri_ipl = BSP_IRQ_DISABLED,
  .p_extend = &g_i2c_cfg_extend, };
