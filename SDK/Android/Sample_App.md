...
1. Project에 oneM2M 모듈 추가
	...
	- Popup 좌상단의 '+' 버튼 클릭
	<br/><img src="images/sample_app/oneM2M_import1.png"/>
	- 'Import Gradle Project' 선택
	<br/><img src="images/sample_app/oneM2M_import2.png"/>
	- SDK folder에 있는 onem2m folder 선택 후 'Finish' 버튼 클릭
	<br/><img src="images/sample_app/oneM2M_import3.png"/>
2. SDK를 사용할 모듈에 onem2m 모듈 연결
	- 'Dependencies' tab에서 우측 '+' 버튼 클릭 후 'Module dependency' 선택
	<br/><img src="images/sample_app/oneM2M_import4.png"/>
	- 'onem2m' 모듈 선택 후 'OK' 버튼 클릭
	<br/><img src="images/sample_app/oneM2M_import5.png"/>
	- 'onem2m' 모듈 이 추가됐는지 확인
	<br/><img src="images/sample_app/oneM2M_import6.png"/>
...
2. App. 권한 승인
	...
	<br/><img src="images/sample_app/permission1.png" width="25%"/> <img src="images/sample_app/permission2.png" width="25%"/> <img src="images/sample_app/permission3.png" width="25%"/>
3. 로그인
	<br/><img src="images/sample_app/login.png" width="25%"/>
	...
	- __서버 환경 설정__(Change Server Info.)
		<br/><img src="images/sample_app/device_server_setting.png" width="25%"/>
    	- ThingPlug portal 정보
    		- Login : 로그인 API URL
...
4. 약관 동의
	<br/><img src="images/sample_app/terms.png" width="25%"/>
	- AGREE : 위치 정보 사용 동의
5. Google account 선택
	<br/><img src="images/sample_app/device_google_account.png" width="25%"/>
    - Camera 촬영 이미지를 업로드할 Google account를 선택한다.
6. 로컬 센서 목록
	<br/><img src="images/sample_app/local_sensor_list.png" width="25%"/>
...
7. 센서 상태 상세
	<br/><img src="images/sample_app/sensor_detail.png" width="25%"/>
    - 센서 상태값을 그래프로 표시한다.
8. 환경 설정
	<br/><img src="images/sample_app/device_setting.png" width="25%"/>
...
2. 로그인
    ...
    - 'Join to be a ThingPlug member'를 선택하면 Web browser에 ThingPlug portal 메인 페이지가 표시된다.
	- __서버 환경 설정__(Change Server Info.)
		<br/><img src="images/sample_app/service_server_setting.png" width="25%"/>
    	- ThingPlug portal 정보
    		- Login : 로그인 API URL
    	...
    	- LOAD DEFAULT : 기본 설정값 불러오기
3. 디바이스 선택
	<br/><img src="images/sample_app/device_list.png" width="25%"/>
	- ThingPlug portal에 등록된 디바이스 목록을 표시한다.
4. Google account 선택
	<br/><img src="images/sample_app/service_google_account.png" width="25%"/>
    - Device App.에서 Camera로 촬영한 이미지를 다운로드할 Google account를 선택한다.
5. 원격 센서 목록
	<br/><img src="images/sample_app/remote_sensor_list.png" width="25%"/>
...
6. 센서 상태 상세
    ...
    - 센서 상태값을 그래프로 표시한다.
7. 환경 설정
	<br/><img src="images/sample_app/service_setting.png" width="25%"/>
